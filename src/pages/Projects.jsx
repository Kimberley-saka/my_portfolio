...
export default function Projects() {
  return (
    <div className="flex flex-col md:text-lg md:my-14 md:px-28">
      <div className="flex rounded-lg flex-col space-y-6 bg-sky-950 md:px-6 md:py-2 md:60 md:80">
        ...
        <div className="flex flex-row space-x-4 ">
          <p className=" flex justify-center items-center border bg-sky-900 rounded-full w-20 h-8">
            React</p>
            <p className=" flex justify-center items-center border bg-sky-900 rounded-full w-28 h-8">
            Tailwind CSS</p>
          <p className=" flex justify-center items-center border bg-sky-900  rounded-full w-20 h-8">
            Django</p>
          <p className=" flex justify-center items-center border bg-sky-900 rounded-full w-20 h-8">
